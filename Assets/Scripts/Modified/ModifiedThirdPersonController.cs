...
#endif
    public class ModifiedThirdPersonController : NetworkBehaviour
    {
        [Header("Player")]
        ...
        private CinemachineVirtualCamera _cinemachineVirtualMainCamera;
        private CinemachineVirtualCamera _minimapCinemachineVirtualCamera;

        private UICanvasControllerInput _uiCanvasControllerInput;
        private ModifiedMobileDisableAutoSwitchControls _mobileDisableAutoSwitchControls;
        ...
        private void Awake()
        {
            ...
            if (_cinemachineVirtualMainCamera == null)
            {
        ...
        public override void OnNetworkSpawn()
        {
            if (IsClient && IsOwner)
            {
                ...
                _cinemachineVirtualMainCamera.Follow = CinemachineCameraTarget.transform;
